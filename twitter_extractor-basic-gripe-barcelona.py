...
indexname = 'twitter-basic-gripe-barcelona'

GEOBOX = [0.5,41.04,3.07,42.18]
LOCATION = "41.38, 2.16"

# GEOBOX_SEVILLA = [-6.95,36.99,-5.12,37.8]
# LOCATION_SEVILLA = "37.39, -5.95"
# GEOBOX_BILBAO = [-4.19,42.59,-1.89,43.72]
# LOCATION_BILBAO = "43.26, -2.93"
# GEOBOX_VALENCIA = [-1.65,38.77,0.92,40.42]
# LOCATION_VALENCIA = "39.45, -0.35"
# GEOBOX_MALAGA = [-5.434,36.4285,-3.6057,37.2511]
# LOCATION_MALAGA = "36.75, -4.39"
